...
LAppModel.prototype.loadObject = function(gl, modelSettingObject, callback)
{
    this.setUpdating(true);
    this.setInitialized(false);

    this.modelHomeDir = modelSettingObject.modelHomeDir; 

    this.modelSetting = new ModelSettingJson();
    
    var thisRef = this;
    
    this.modelSetting.loadModelSettingObj(modelSettingObject, function(){
